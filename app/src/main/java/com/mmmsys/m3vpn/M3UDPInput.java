...
public class M3UDPInput implements Runnable
{
    private static final String TAG = M3UDPInput.class.getSimpleName();
    private static final int HEADER_SIZE = Packet.IP4_HEADER_SIZE + Packet.UDP_HEADER_SIZE;

    private Selector selector;
    private ConcurrentLinkedQueue<ByteBuffer> outputQueue;

    public M3UDPInput(ConcurrentLinkedQueue<ByteBuffer> outputQueue, Selector selector)
    {
